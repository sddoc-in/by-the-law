                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style={{ textAlign: "center", top: 0, border: "2px solid black", borderCollapse: "collapse" }} rowSpan={3}>
                               <div className="bg-green-200 w-full h-.5 text-center text-red-500 border-red-500">To Keep outher people from seeing what you entered on your from, please press the Clear This Form button at the end of the form when finished</div>
                            </td>
                        </tr>
                        <tr>
