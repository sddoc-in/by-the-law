...
export default function Divorce() {
    return (
        ...
        <div className="main">
            ...
            <h2 className="text-center" style={{ marginTop: "5rem" }}>Divorce Intake Questionnaire</h2>
            ...
            <div className="mt" style={{ display: "flex", justifyContent: "space-between" }}>
                <p>Exclusive possession of marital residence:
                    <p>Y</p>
                    <p>N</p>
                    <p>for</p>
                    <p>H</p>
            ...
            <div className="mt" style={{ width: "80%", margin: "auto" }}>
                ...
                <input type="text" style={{ width: "60rem" }} className="mt" />
                <br />
                v                                                       <input type="text" style={{ width: "60rem" }} className="mt" />
                <br />
                <input type="text" style={{ width: "60rem" }} className="mt" />
                <br />
                <input type="text" style={{ width: "60rem" }} className="mt" />
            ...
            <div style={{ width: '9%', margin: "auto", paddingTop: "30px", height: "40px" }}>
